      ...
      <div className="search-bar-container">
        ...
        <div className="players-wrapper">
          <div className="player-column">
            ...
            <PlayerSearch players={players} selectedPlayer={player1} onSelect={setPlayer1} onClear={() => setPlayer1(null)} />
            <PlayerStats player={player1} />
          </div>

          <div className="player-column">
            <h2 style={{ marginTop: "20px" }}>Player 2:</h2>
            <PlayerSearch players={players} selectedPlayer={player2} onSelect={setPlayer2} onClear={() => setPlayer2(null)} />
